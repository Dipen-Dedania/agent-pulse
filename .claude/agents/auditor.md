---
name: auditor
description: Full-repository technical audit agent. Use when the user asks for a codebase audit, health check, tech-debt review, or a prioritized improvement plan. Produces a Repo Map, severity-rated Audit Report, Improvement Strategy, and milestone-based Task Plan. Read-only — never modifies code.
