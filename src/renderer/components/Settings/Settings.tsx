    ...
    <div className="min-h-screen bg-slate-900 text-white p-8 font-sans">
      <div className="max-w-4xl mx-auto">
        <header className="mb-12">
          ...
          <p className="text-slate-400">Manage your AI agent status bubbles.</p>
        </header>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-slate-800/50 border border-slate-700 p-6 rounded-2xl backdrop-blur-md">
            ...
            <div className="space-y-4">
              {['claude-code', 'cursor', 'vscode-copilot', 'openai-codex'].map((toolId) => (
                <div key={toolId} className="flex items-center justify-between p-3 bg-slate-900/50 rounded-xl border border-slate-700">
          ...
          <div className="bg-slate-800/50 border border-slate-700 p-6 rounded-2xl backdrop-blur-md">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col">
                <label className="block text-sm text-slate-400 mb-2">Bubble Opacity</label>
                <input type="range" className="w-full accent-blue-500" />
              </div>
              <div className="flex items-center gap-3">
                <input type="checkbox" id="mute" className="w-4 h-4 accent-blue-500" />
                <label htmlFor="mute" className="text-sm text-slate-400">Mute all animations</label>
              </div>
            </div>
          </div>
        </section>
